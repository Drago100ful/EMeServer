...
#define TX_PIN 20                                          // Tx pin which the MHZ19 Rx pin is attached to
...
static void prepareTxFrame( uint8_t port )
{
  ...
  */
    ...
    for (int counter = 0; counter < 48; counter += 2) {
      CO2 = myMHZ19.getCO2();
      appData[counter] = highByte(CO2);
      appData[counter+1] = lowByte(CO2);

      sleep(150);
    }

    int voltage = analogRead(7);

    appData[49] = highByte(voltage);
    appData[50] = lowByte(voltage);
}
